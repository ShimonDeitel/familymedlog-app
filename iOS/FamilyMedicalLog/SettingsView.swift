...
struct SettingsView: View {
    ...
    @AppStorage("familymedlog_notifyEnabled") private var notifyEnabled = true
    @AppStorage("familymedlog_iCloudSyncEnabled") private var iCloudSyncEnabled = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/familymedlog-app/privacy.html")!)
                    Text("Version 1.0")
